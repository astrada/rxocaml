...
(* OASIS_START *)
(* DO NOT EDIT (digest: 70bbc479873c66a8e24265bd4fb13bbc) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          description =
            Some
              "RxOCaml is an OCaml implementation of Rx Observables\n(https://rx.codeplex.com/).";
          categories = [];
     ...
     oasis_version = "0.4.1";
     oasis_digest = Some "Ko:b\024\176\145\134\177B\192\203[\167\227\185";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
