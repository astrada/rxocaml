...
(* OASIS_START *)
(* DO NOT EDIT (digest: abefdd7d48ffca10cdd7026630c42777) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          homepage = Some "http://rxocaml.forge.ocamlcore.org";
          synopsis = "An OCaml implementation of RX Observables.";
          description =
            Some
              [
                 OASISText.Para
                   "RxOCaml is a library for composing asynchronous and event-based programs using observable sequences. This library is an OCaml implementation of Rx Observables (https://rx.codeplex.com/)."
              ];
          categories = [];
               ...
               Doc
                 ({
                  ...
                  },
                   {
                      ...
                      doc_title =
                        "API reference for Reactive Extensions (Rx)";
                      doc_authors = [];
                      doc_abstract = None;
                      doc_format = OtherDoc;
               ...
               Executable
                 ({
                  ...
                  },
                   {
                      ...
                      bs_install = [(OASISExpr.EBool true, false)];
                      bs_path = "examples/hello";
                      bs_compiled_object = Byte;
                      bs_build_depends = [InternalLibrary "rxocaml"];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                      bs_data_files = [];
                      bs_ccopt = [(OASISExpr.EBool true, [])];
               ...
               SrcRepo
                 ({
                  ...
                  },
                   {
                      src_repo_type = Git;
                      src_repo_location =
                        "https://github.com/astrada/rxocaml.git";
                      src_repo_browser =
                        Some "https://github.com/astrada/rxocaml";
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "Lk\181\211#_\136\221i\130ag\172\146\170\139";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
